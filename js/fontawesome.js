...
! function(t) {
	...
	function o(t) {
		for (var o = 1; o < arguments.length; o++) {
			...
			o % 2 ? n(Object(r), !0).forEach((function(n) {
				...
				.getOwnPropertyDescriptors(r)) : n(Object(r)).forEach((function(e) {
	...
	function r(t, e) {
		return function(t) {
			...
			if (!(Symbol.iterator in Object(t) || "[object Arguments]" === Object.prototype.toString.call(
					t))) return;
			var n = [],
				o = !0,
				r = !1,
				i = void 0;
			try {
				for (var c, a = t[Symbol.iterator](); !(o = (c = a.next()).done) && (n.push(c.value), !e ||
						n.length !== e); o = !0);
			} catch (t) {
				r = !0, i = t
			} finally {
	...
	function c(t, e) {
		...
		Array.prototype.forEach.call(r, (function(e) {
			...
			if (n && o) {
				...
				r.innerHTML = n, r.classList.add("sr-only"), e.parentNode.insertBefore(r, e
					.nextSibling)
			}
		}))
	}
	var a, u = function() {},
		f = "undefined" != typeof global && void 0 !== global.process && "function" == typeof global.process
		.emit,
	...
	j.prototype = {
		...
		then: function(t, e) {
			...
			return !e && !t || this._handled || (this._handled = !0, "rejected" === this._state && f &&
					h(O, this)), "fulfilled" === this._state || "rejected" === this._state ? h(m, n) :
		...
		return new j((function(e, n) {
			...
			for (var c, a = 0; a < t.length; a++)(c = t[a]) && "function" == typeof c.then ? c
				.then(i(a), n) : o[a] = c;
			r || e(o)
		}))
	}, j.race = function(t) {
		...
		return new j((function(e, n) {
			for (var o, r = 0; r < t.length; r++)(o = t[r]) && "function" == typeof o.then ? o
				.then(e, n) : e(o)
		}))
	...
	function P(t, e) {
		...
		return n.appendChild(o), n.media = "all", e.id && n.setAttribute("id", e.id), e && e
			.detectingConflicts && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e
				.detectionIgnoreAttr)), n
	}

	function F(t, e) {
		e.autoA11y = t.autoA11y.enabled, "pro" === t.license && (e.autoFetchSvg = !0, e.fetchSvgFrom = t
			.baseUrl + "/releases/" + ("latest" === t.version ? "latest" : "v".concat(t.version)) + "/svgs",
		...
		return t.v4shim.enabled && n.push(new S((function(n, r) {
			...
			E(i(t, {
				...
				n(function(t, e) {
					var n = e && void 0 !== e.autoFetchSvg ? e
						.autoFetchSvg : void 0,
						o = e && void 0 !== e.autoA11y ? e.autoA11y :
						void 0;
					void 0 !== o && t.setAttribute("data-auto-a11y", o ?
						"true" : "false");
					n && (t.setAttributeNode(document.createAttribute(
							"data-auto-fetch-svg")), t.setAttribute(
							"data-fetch-svg-from", e.fetchSvgFrom), t
						.setAttribute("data-fetch-uploaded-svg-from", e
	...
	function T(t, e) {
		...
		return n.appendChild(o), n.referrerPolicy = "strict-origin", e.id && n.setAttribute("id", e.id), e && e
			.detectingConflicts && e.detectionIgnoreAttr && n.setAttributeNode(document.createAttribute(e
				.detectionIgnoreAttr)), n
	}
